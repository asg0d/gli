...
from .models import Billboard, BillboardImage, Employee
...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Employee
        fields = ['id', 'first_name', 'last_name', 'full_name', 'email', 'phone', 'position']
...
class BillboardSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'width', 'height', 'size', 'address', 'latitude', 'longitude',
            'location', 'start_date', 'end_date', 'period', 'status',
            'price', 'notes', 'images', 'days_until_expiry',
...
class BillboardListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Billboard
        fields = [
            'id', 'images', 'employee', 'size', 'address', 
